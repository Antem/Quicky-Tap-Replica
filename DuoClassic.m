...
{
    ScoreOne = ScoreOne + 1;
    InGameScoreOne.text = [NSString stringWithFormat:@"%i of 25", ScoreOne];
...
{
    ScoreTwo = ScoreTwo + 1;
    InGameScoreTwo.text = [NSString stringWithFormat:@"%i of 25", ScoreTwo];
...
-(void)Dead
{
      if (DOne == YES && DTwo == YES) {
        ...
        DisplayOne.image = [UIImage imageNamed:@"BothBlack.png"];
        DisplayTwo.image = [UIImage imageNamed:@"BothBlack.png"];
      } else if (One == YES && DTwo == YES) {
          PlayerOneWiat.hidden = YES;
          PlayerTwoWait.hidden = YES;
          InGameScounterOne.hidden = YES;
          InGameScoreOne.hidden = YES;
...
-(void)Compare
{
    ...
    PlayerOneOne.text = [NSString stringWithFormat:@"%.2f", CounterOne];
    PlayerOneTwo.text = [NSString stringWithFormat:@"%.2f", CounterTwo];
    
    PlayerTwoOne.text = [NSString stringWithFormat:@"%.2f", CounterOne];
    PlayerTwoTwo.text = [NSString stringWithFormat:@"%.2f", CounterTwo];
